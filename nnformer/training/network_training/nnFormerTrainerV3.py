...
class nnFormerTrainerV3(nnFormerTrainer):
    """
    ...
    def initialize_network(self):
        ...
        if self.load_pretrain_weight:
            checkpoint = torch.load("%s/nnformer/tumor_pretrain.model" % os.environ["savemodel"], map_location='cpu', weights_only=False)
            ck={}
...
class nnFormerTrainerV3Lr5e3(nnFormerTrainerV3):
...
class nnFormerTrainerV3Lr1e3(nnFormerTrainerV3):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None, unpack_data=True, deterministic=True, fp16=False):
        super().__init__(plans_file, fold, output_folder, dataset_directory, batch_dice, stage, unpack_data, deterministic, fp16)
        self.initial_lr = 1e-3
        

class nnFormerTrainerV3Lr5e4(nnFormerTrainerV3):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None, unpack_data=True, deterministic=True, fp16=False):
        super().__init__(plans_file, fold, output_folder, dataset_directory, batch_dice, stage, unpack_data, deterministic, fp16)
        self.initial_lr = 5e-4


class nnFormerTrainerV3Lr1e4(nnFormerTrainerV3):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None, unpack_data=True, deterministic=True, fp16=False):
        super().__init__(plans_file, fold, output_folder, dataset_directory, batch_dice, stage, unpack_data, deterministic, fp16)
